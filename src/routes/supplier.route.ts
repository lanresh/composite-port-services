...
export class SupplierRoute implements Routes {
    ...
    private initializeRoutes() {
        this.router.post(`${this.path}`, AuthMiddleware, ValidationMiddleware(CreateSupplierDto), this.supplier.createSupplier);
        ...
        this.router.put(`${this.path}/:id`, AuthMiddleware, this.supplier.updateSupplier);
        this.router.delete(`${this.path}/:id`, AuthMiddleware, this.supplier.deleteSupplier);
    }
