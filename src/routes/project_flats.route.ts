...
export class ProjectFlatsRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.get(`${this.path}`, AuthMiddleware, PrivilegeMiddleware('can_view', 'project'), this.project_flats.getProjectFlats);
    this.router.get(`${this.path}/:id`, AuthMiddleware, PrivilegeMiddleware('can_view', 'project'), this.project_flats.getProjectFlat);
    this.router.get(`${this.path}/project-code/code`, AuthMiddleware, PrivilegeMiddleware('can_view', 'project'), this.project_flats.getProjectFlatsByProjectCode);
