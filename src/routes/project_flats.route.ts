...
export class ProjectFlatsRoute implements Routes {
  ...
  private initializeRoutes() {
    this.router.post(
      ...
      ValidationMiddleware(CreateProjectFlatsDto),
      this.project_flats.createProjectFlats,
    );
    ...
    this.router.put(
      ...
      ValidationMiddleware(CreateProjectFlatsDto, true),
      this.project_flats.updateProjectFlats,
    );
