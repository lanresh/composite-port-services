...
export class ContractorRoute implements Routes {
  ...
  private initializeRoutes() {
    this.router.post(`${this.path}`, AuthMiddleware, PrivilegeMiddleware('can_create', 'contractor'), ValidationMiddleware(CreateContractorDto), this.contractor.createContractor);
    this.router.get(`${this.path}`, AuthMiddleware, PrivilegeMiddleware('can_view', 'contractor'), this.contractor.getAllContractors);
    this.router.get(`${this.path}/:id`, AuthMiddleware, PrivilegeMiddleware('can_view', 'contractor'), this.contractor.getContractor);
